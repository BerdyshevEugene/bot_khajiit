...
class Keyboards:
    ...
    def category_menu(self):
        ...
        self.markup.add(self.set_btn('SHIRTS'))
        self.markup.add(self.set_btn('T-SHIRTS'))
        self.markup.add(self.set_btn('PANTS'))
    ...
    def set_inline_btn(name):
        """
        Создает и возвращает inline кнопку по входным параметрам
        """
    ...
    def set_select_category(self, category):
        """
        Создает разметку инлайн кнопок в выбранной категории товара
        и возвращает разметку
        """
        self.markup = InlineKeyboardMarkup(row_width=1)
        # загружаем в название inline кнопок данные
