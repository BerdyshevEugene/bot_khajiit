...
class HandlerInlineQuery(Handler):
    ...
    сообщения при нажатии inline кнопки
    """
    ...
    def pressed_btn_product(self, call, code):
        """
        Обрабатывает входящие запросы при нажатии inline кнопки товара
        """
    ...
    def handle(self):
        # обработчик (декоратор) запросов при нажатии на кнопку товара
