...
<b>Добро пожаловать в приложение Mosonhand</b>

Данное приложение разработано
для поиска и покупки интересной одежды.
Здесь можно сформировать заказ
и в удобном виде отправить сформированный заказ в работу.
По дополнительным вопросам обращайтесь:
https://www.instagram.com/mos.on.hand/
...
ДЛЯ КОМПЛЕКТОВАНИЯ И ОТПРАВКИ. </b>
"""
